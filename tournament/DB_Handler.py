...
class DB_Handler(object):
    ...
    # initialization: Can configure all properties with included keyword
    # arguments
    # __ are used to label methods as private, yet this may not be
    # enough security
    ...
    # Handle incoming query. Takes 1 argument query for requested
    # query statement
